...
(function(){
  ...
  var DEFAULT_PEOPLE = [
    { email: 'lewis@vyvehealth.co.uk', name: 'Lewis Vines',  role: 'owner', external: false, addedAt: new Date('2026-01-01').toISOString() },
    { email: 'dean@vyvehealth.co.uk',  name: 'Dean Brown',   role: 'owner', external: false, addedAt: new Date('2026-01-01').toISOString() }
  ];
  ...
  function removePerson(email) {
    ...
    if (e === 'lewis@vyvehealth.co.uk') return false;
