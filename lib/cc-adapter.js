...
(function(){
  ...
  var ENTITIES = {
    tasks: {
      ...
      nativeSupabase: true   // migrated to Supabase as of Commit 66
    },
    deals: {
    ...
    content: {
      ...
      missingInCC: [],
      ccOnly: ['created_by', 'created_at', 'updated_at', 'published_at'],
      nativeSupabase: true   // migrated to Supabase as of Commit 67
    },
    invoices: {
      lsKey: 'vyve_invoices',
      ccTable: 'cc_invoices',
