...
(function(){
  ...
  var GLOBAL = [
    ...
    { keys: 'g b',     label: 'Go to Brief',                 scope: 'global', action: function(){ location.hash = '#/brief'; } },
    { keys: 'g i',     label: 'Go to Inbox',                 scope: 'global', action: function(){ location.hash = '#/inbox'; } },
    { keys: 'g d',     label: 'Go to Dashboard',             scope: 'global', action: function(){ location.hash = '#/dashboard'; } },
    ...
    { keys: 'g a',     label: 'Go to Action Plans',          scope: 'global', action: function(){ location.hash = '#/action-plans'; } },
    { keys: 'g s',     label: 'Go to Sessions',              scope: 'global', action: function(){ location.hash = '#/sessions'; } },
    { keys: 'g f',     label: 'Go to Finance',               scope: 'global', action: function(){ location.hash = '#/finance'; } },
    { keys: 'g x',     label: 'Go to Activity',              scope: 'global', action: function(){ location.hash = '#/activity'; } },
